...
var Collision = /** @class */ (function () {
    ...
    function Collision(_a) {
        var _this = this;
        var canvas = _a.canvas, _b = _a.balls, balls = _b === void 0 ? [] : _b, _c = _a.speedMin, speedMin = _c === void 0 ? -2 : _c, _d = _a.speedMax, speedMax = _d === void 0 ? 2 : _d, _e = _a.bgColor, bgColor = _e === void 0 ? 'transparent' : _e, _f = _a.docEl, docEl = _f === void 0 ? document.documentElement : _f, _g = _a.designWidth, designWidth = _g === void 0 ? 375 : _g, _h = _a.scaleInPC, scaleInPC = _h === void 0 ? true : _h, _j = _a.resetOnResize, resetOnResize = _j === void 0 ? true : _j, _k = _a.resetOnlyWidth, resetOnlyWidth = _k === void 0 ? true : _k;
        this.balls = [];
        /**
         * 开始运动
         */
        ...
        this._onResize = lodash_debounce(function () {
            var flag = _this.resetOnlyWidth && _this.docElWidth !== _this.docEl.clientWidth || !_this.resetOnlyWidth;
            if (flag) {
                _this.destroy();
                _this._init();
            }
    ...
    Collision.prototype._create = function () {
        ...
        var rateScale = !this.scaleInPC && !isMobile ? 1 : docWidth / this.designWidth;
...
//# sourceMappingURL=ball-collision.es5.js.map
